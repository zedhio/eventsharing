...
class Mregister extends CI_Model {
	...
	function register_member($data)
	{
		...
		$mail->Subject = "Aktivasi Akun Event Sharing";
	...
	function konfirmasi_akun($token){
...
/* End of file Mregister.php */
/* Location: ./application/models/Mregister.php */